...
KTMenu.initHandlers = function() {
  ...
  // Sub toggle handler(vahid)
  // KTUtil.on(document.body,  '.vahid .vahidInput', 'keyup', function(e) {
  //   console.log('are');
  //   var element = document.getElementsByClassName("vahidModal");
  //   console.log('element =>',element);
  //   var x = document.getElementsByClassName("vahidInput")[0].value;
  //   if(x!=''){
